package net.dantemc.civitascapes.render;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.math.Axis;
import net.dantemc.civitascapes.cape.CapeManager;
...
@OnlyIn(Dist.CLIENT)
public class CivitasCapeLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    public CivitasCapeLayer(RenderLayerParent<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> renderer) {
        super(renderer);
    }
    ...
    public void render(
        ...
        if (!livingEntity.isInvisible() && livingEntity.isModelPartShown(PlayerModelPart.CAPE)) {
            ResourceLocation cape = CapeManager.getCape(livingEntity.getUUID());
            if (cape != null) {
